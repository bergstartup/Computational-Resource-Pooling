...
if (debug)
 ...
 //Parent
  ...
  int status,syscall,wstatus,kill=0,count=0;
  ...
  //craete a listenting socket and get a client connection for ecporting I/O
      ...
      switch(syscall){
          ...
          */
          ...
          //write syscall
        	case 1:
             ...
             memcpy((char *)cmp_msg+1+sizeof(int),&regs.rdi,sizeof(int));
         ...
         //fstat syscall
          ...
          case 257:
            ...
            cmp_msg = (char *)malloc(sizeof(long long int)+4*sizeof(int)+255+4);
            memcpy((char *)cmp_msg,&syscall,sizeof(int));
            memcpy((char *)cmp_msg+1+sizeof(int),&regs.rdi,sizeof(long long int));
